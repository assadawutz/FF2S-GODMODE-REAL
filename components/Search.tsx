...
/* mock summary — ในโปรดักชันให้ดึงจาก AI จริง */
const aiSummary = `
      ...
      <div className="w-full flex justify-center">
        <div className="w-full max-w-[1140px] mx-auto px-6 lg:px-10 flex flex-col">
          ...
          <div className="flex flex-col items-center text-center">
            ...
            {/* Small Title */}
            <div className="text-base sm:text-lg font-medium uppercase tracking-[8px] sm:tracking-[14px] text-okmd-cyan">
            ...
            <div className="mt-4 flex w-full flex-col items-center gap-4 sm:gap-6">
              <h2 className="max-w-[750px] text-2xl sm:text-3xl lg:text-4xl font-semibold leading-tight text-okmd-dark">
                รวมไอเดียเด็ด แรงบันดาลใจเจ๋ง ๆ และ
              </h2>
              <p className="text-xl sm:text-2xl lg:text-3xl text-okmd-cyan">
                ความรู้นอกตำรา OKMD  โลกของคนชอบคิดต่าง
              </p>
            </div>

            {/* SEARCH BLOCK */}
            <div className="relative mt-10 w-full max-w-[760px] px-2 sm:px-0">

              {/* Gradient BG */}
              <div className="h-[210px] sm:h-[177px] w-full p-3 rounded-3xl bg-gradient-to-r from-okmd-bg-one via-okmd-bg-two to-okmd-bg-three" />

              {/* White card */}
              <div className="absolute left-[4%] top-[43%] sm:left-[14px] sm:top-[51px] h-[110px] sm:h-[121px] w-[92%] sm:w-[calc(100%-28px)] rounded-2xl bg-white shadow-md" />
...
>
  ...
  ช่วยให้คุณได้คำตอบตรงใจ รวดเร็ว
              ...
              {/* Subtitle */}
              <div className="absolute left-[40px] top-[120px] sm:left-[30px] sm:top-[74px] text-[11px] sm:text-xs leading-[18px] text-okmd-dark">
                การค้นหาที่ฉลาดและแม่นยำ
              </div>

              {/* Input */}
              <div className="absolute left-[40px] top-[140px] sm:left-[30px] sm:top-[97px] right-[60px] flex items-center">
                <input
                  type="text"
                  placeholder="พิมพ์เป้าหมายของคุณที่นี่"
                  className="flex-1 border-b-2 border-okmd-cyan bg-transparent pl-2 text-sm sm:text-base text-okmd-gray outline-none placeholder:text-okmd-gray focus:border-okmd-blue"
                />

                <button
                  className="ml-3 flex items-center justify-center h-8 w-8 sm:h-10 sm:w-10 rounded-full bg-gradient-to-b from-okmd-cyan to-okmd-blue shadow-lg hover:scale-105 transition"
                >
